...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        """
        self.info_button = Button(self, text="info", command=self.print_info, state=ACTIVE)
        self.info_button.grid(row=8, column=15)
        """
    ...
    def decode_ssdv(self):
        ...
        if self.serialPort.isOpen():
            ...
            if newPackets >= 1:
                self.after(3000, self.decode_ssdv)
            else:
                self.after(6000, self.decode_ssdv)
    ...
    def upload_listener_information(self, callsign, latitude, longitude):
        ...
        print("Listener information uploaded.")
        return doc_id
    ...
    def upload_listener_telemetry(self, callsign, latitude, longitude, altitude):
        ...
        print("Listener telemetry uploaded.")
        return doc_id
    ...
    def upload_payload_telemetry(self, string, listener):
        ...
        for i in xrange(self._max_merge_attempts):
            try:
                ...
                print("Telemetry string uploaded.") # tempppppppppppppppppppppppppppp
    ...
    def upload_ssdv_packet(self, pkt, listener):
        ...
        print(r.status_code, self._queue.qsize())
        return r
    ...
    def print_info(self):
        """  """
        #font = tkFont.Font(font=self.onoff_label['font'])
        #print font.actual()
        #print("Info:")
        #print(self.thread.is_alive(), threading.enumerate())
    """
    def __del__(self):
        """ Cleanup """
        self.serialPort.close()
